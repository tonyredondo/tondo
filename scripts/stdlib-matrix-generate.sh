...
jq -n \
    ...
    def owner_stage_templates($id; $manifest; $integration; $performance_contract; $performance_manifest; $codec; $sources):
        (owner_contract($id; $sources)) as $source
        | (if $source == null then
        ...
        | [{id: "SPEC", value: $spec_stage}, {id: "IMPL/HOST", value: implementation_stage($id; $manifest)}, {id: "MODEL/TEST/FUZZ", value: model_stage($id; $manifest; owner_has_test_matrix($id; $sources))}, {id: "PERF", value: performance_stage($id; $performance_contract; $performance_manifest)}, {id: "CONF", value: conformance_stage($id; $codec)}, {id: "DOC", value: doc_stage(contract_for_owner($id; $integration))}];

    def owner_rows($id; $manifest; $api; $integration; $performance_contract; $performance_manifest; $codec; $sources):
        ...
        | (requirement_definitions($id; $sources) | map(. as $requirement
            ...
            | [{id: "SPEC", value: $spec_stage}, {id: "IMPL/HOST", value: $owner_impl}, {id: "MODEL/TEST/FUZZ", value: $model}, {id: "PERF", value: $perf}, {id: "CONF", value: conformance_stage($id; $codec)}, {id: "DOC", value: $doc}] as $stages
        ...
        | ($api.rows | map(select(.owner == $id)) | map(. as $row
            ...
            | [{id: "SPEC", value: {status: "verified", reason: null, refs: [$row.contract + "#" + ($row.line | tostring)]}}, {id: "IMPL/HOST", value: $impl_stage}, {id: "MODEL/TEST/FUZZ", value: $model_stage}, {id: "PERF", value: $perf}, {id: "CONF", value: conformance_stage($id; $codec)}, {id: "DOC", value: $doc}] as $stages
