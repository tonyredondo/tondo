...
grep -Fq 'STD-ASYNC-GROUP-CONF-001' testing/stdlib-async-group-conformance.json
grep -Fq 'verified-native-runtime-abi' testing/stdlib-async-group-conformance.json
