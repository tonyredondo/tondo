...
run_step stdlib-encoding-testing-contract \
...
run_step stdlib-encoding-documentation-contract \
    scripts/stdlib-encoding-doc-check.sh
run_step stdlib-encoding-documentation-contract-tests \
    scripts/stdlib-encoding-doc-test.sh
...
run_step stdlib-yaml-testing-contract \
...
run_step stdlib-yaml-conformance-contract \
    scripts/stdlib-yaml-conformance-check.sh
run_step stdlib-yaml-conformance-contract-tests \
