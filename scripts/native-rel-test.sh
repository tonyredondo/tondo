...
build_package() {
    ...
    jq -n --arg binary "sha256:$binary_hash" --arg runtime "sha256:$runtime_hash" \
        ...
        '{format:"tondo-native-package/1",compiler:"tondo-0.1-development",edition:"0.1",target:"tondo-native-linux-x86-64-release",triple:"x86_64-unknown-linux-gnu",profile:"release",backend_selection:"cranelift",promotion:"pending-gate-n1",contents:{binary:{path:"bin/tondo",sha256:$binary},runtime:{id:"tondo-native-runtime/1",sha256:$runtime},stdlib:{id:"STD-0.1A",sha256:$stdlib},target:{sha256:$target}},physical_paths:[],timestamps:false}' \
