...
fn bootstrap_process_intrinsic(module: &ModuleId, name: &Name) -> Option<IntrinsicType> {
    ...
    match module.path().as_str() {
        ...
        "sync" => Some(match name.as_str() {
            "Mutex" => IntrinsicType::Mutex,
            "MutexGuard" => IntrinsicType::MutexGuard,
            "RwLock" => IntrinsicType::RwLock,
            "ReadGuard" => IntrinsicType::ReadGuard,
            "WriteGuard" => IntrinsicType::WriteGuard,
            "Condition" => IntrinsicType::Condition,
            "Semaphore" => IntrinsicType::Semaphore,
            "Permit" => IntrinsicType::Permit,
            "Once" => IntrinsicType::Once,
            "Barrier" => IntrinsicType::Barrier,
            "Atomic" => IntrinsicType::Atomic,
            _ => return None,
        }),
        ...
        "json" => Some(match name.as_str() {
            "JsonLimits" => IntrinsicType::JsonLimits,
            "JsonDecodeOptions" => IntrinsicType::JsonDecodeOptions,
            "JsonEncodeOptions" => IntrinsicType::JsonEncodeOptions,
            "JsonDuplicatePolicy" => IntrinsicType::JsonDuplicatePolicy,
            "JsonUnknownFieldPolicy" => IntrinsicType::JsonUnknownFieldPolicy,
            "JsonNumberPolicy" => IntrinsicType::JsonNumberPolicy,
        ...
        "yaml" => Some(match name.as_str() {
            "YamlLimits" => IntrinsicType::YamlLimits,
            "YamlOptions" => IntrinsicType::YamlOptions,
            "Value" => IntrinsicType::YamlValue,
            "ValueView" => IntrinsicType::YamlValueView,
            "YamlReader" => IntrinsicType::YamlReader,
...
pub enum HirBootstrapHostFunction {
    ...
    SyncMutexTryLock,
    SyncMutexGuardGet,
    SyncMutexGuardGetMut,
    SyncMutexGuardUnlock,
    SyncRwLock,
    SyncRwLockRead,
    SyncRwLockTryRead,
    SyncReadGuardGet,
    ...
    SyncRwLockTryWrite,
    SyncWriteGuardGet,
    SyncWriteGuardGetMut,
    SyncWriteGuardUnlock,
    SyncCondition,
    SyncConditionWait,
    SyncConditionNotifyOne,
    SyncConditionNotifyAll,
    SyncSemaphore,
    SyncSemaphoreAcquire,
    SyncSemaphoreTryAcquire,
    SyncPermitRelease,
    SyncOnce,
    SyncOnceGet,
    SyncOnceGetOrInit,
    ...
    SyncMemoryOrderAcqRel,
    SyncMemoryOrderSeqCst,
    BytesFromString,
    BytesToString,
    BytesEmpty,
    BytesFromArray,
    ...
    JsonNumberFloat64,
    JsonLimitsConstruct,
    JsonDecodeOptionsConstruct,
    JsonEncodeOptionsConstruct,
    JsonValidate,
    JsonCanonicalize,
    JsonParse,
    JsonParseView,
    ...
    EncodingBase64AlphabetStandard,
    EncodingBase64AlphabetUrlSafe,
    EncodingBase64PaddingRequired,
    EncodingBase64PaddingOmitted,
    EncodingHexCaseLower,
    EncodingHexCaseUpper,
    EncodingHexCaseAny,
    EncodingLimitsDefaults,
    EncodingLimitsCreate,
    EncodingBase64OptionsCreate,
    EncodingBase64OptionsStandard,
    EncodingBase64OptionsUrlSafe,
    EncodingBase64OptionsUrlSafeUnpadded,
    EncodingBase64OptionsEncode,
    EncodingBase64OptionsDecode,
    EncodingBase64OptionsEncodeTo,
    EncodingBase64OptionsDecodeFrom,
    EncodingBase64OptionsEncoder,
    EncodingBase64OptionsDecoder,
    EncodingHexOptionsCreate,
    EncodingHexOptionsLower,
    EncodingHexOptionsUpper,
    EncodingHexOptionsAnyCase,
    EncodingHexOptionsEncode,
    EncodingHexOptionsDecode,
    EncodingHexOptionsEncodeTo,
    EncodingHexOptionsDecodeFrom,
    EncodingHexOptionsEncoder,
    EncodingHexOptionsDecoder,
    EncodingBase64EncoderPush,
    EncodingBase64EncoderFinish,
    EncodingBase64DecoderPush,
    EncodingBase64DecoderFinish,
    EncodingHexEncoderPush,
    EncodingHexEncoderFinish,
    EncodingHexDecoderPush,
    EncodingHexDecoderFinish,
    MessagePackValidate,
...
impl HirBootstrapHostFunction {
    pub const fn name(self) -> &'static str {
        match self {
            ...
            Self::CommandMergeStderr => "std.process.Command.mergeStderr",
            ...
            Self::PipelineMergeStderr => "std.process.Pipeline.mergeStderr",
            ...
            Self::SyncMutex => "std.sync.mutex",
            Self::SyncMutexLock => "std.sync.Mutex.lock",
            Self::SyncMutexTryLock => "std.sync.Mutex.tryLock",
            Self::SyncMutexGuardGet => "std.sync.MutexGuard.get",
            Self::SyncMutexGuardGetMut => "std.sync.MutexGuard.getMut",
            Self::SyncMutexGuardUnlock => "std.sync.MutexGuard.unlock",
            Self::SyncRwLock => "std.sync.rwLock",
            Self::SyncRwLockRead => "std.sync.RwLock.read",
            Self::SyncRwLockTryRead => "std.sync.RwLock.tryRead",
            Self::SyncReadGuardGet => "std.sync.ReadGuard.get",
            Self::SyncReadGuardUnlock => "std.sync.ReadGuard.unlock",
            Self::SyncRwLockWrite => "std.sync.RwLock.write",
            Self::SyncRwLockTryWrite => "std.sync.RwLock.tryWrite",
            Self::SyncWriteGuardGet => "std.sync.WriteGuard.get",
            Self::SyncWriteGuardGetMut => "std.sync.WriteGuard.getMut",
            Self::SyncWriteGuardUnlock => "std.sync.WriteGuard.unlock",
            Self::SyncCondition => "std.sync.condition",
            Self::SyncConditionWait => "std.sync.Condition.wait",
            Self::SyncConditionNotifyOne => "std.sync.Condition.notifyOne",
            Self::SyncConditionNotifyAll => "std.sync.Condition.notifyAll",
            Self::SyncSemaphore => "std.sync.semaphore",
            Self::SyncSemaphoreAcquire => "std.sync.Semaphore.acquire",
            Self::SyncSemaphoreTryAcquire => "std.sync.Semaphore.tryAcquire",
            Self::SyncPermitRelease => "std.sync.Permit.release",
            Self::SyncOnce => "std.sync.once",
            Self::SyncOnceGet => "std.sync.Once.get",
            Self::SyncOnceGetOrInit => "std.sync.Once.getOrInit",
            Self::SyncOnceIsReady => "std.sync.Once.isReady",
            Self::SyncBarrier => "std.sync.barrier",
            Self::SyncBarrierWait => "std.sync.Barrier.wait",
            Self::SyncAtomic => "std.sync.atomic",
            Self::SyncAtomicLoad => "std.sync.Atomic.load",
            ...
            Self::ExecutorActorRef => "std.executor.Actor.ref",
            ...
            Self::SyncMemoryOrderAcqRel => "intrinsic.sync.MemoryOrder.AcqRel",
            Self::SyncMemoryOrderSeqCst => "intrinsic.sync.MemoryOrder.SeqCst",
            ...
            Self::ProcessOutputCombined => "std.process.ProcessOutput.combined",
            ...
            Self::JsonDuplicateReject => "intrinsic.json.JsonDuplicatePolicy.Reject",
            Self::JsonDuplicateFirst => "intrinsic.json.JsonDuplicatePolicy.First",
            Self::JsonDuplicateLast => "intrinsic.json.JsonDuplicatePolicy.Last",
            Self::JsonUnknownReject => "intrinsic.json.JsonUnknownFieldPolicy.Reject",
            Self::JsonUnknownIgnore => "intrinsic.json.JsonUnknownFieldPolicy.Ignore",
            Self::JsonUnknownCapture => "intrinsic.json.JsonUnknownFieldPolicy.Capture",
            Self::JsonNumberExact => "intrinsic.json.JsonNumberPolicy.Exact",
            Self::JsonNumberFloat32 => "intrinsic.json.JsonNumberPolicy.Float32",
            Self::JsonNumberFloat64 => "intrinsic.json.JsonNumberPolicy.Float64",
            Self::JsonLimitsConstruct => "intrinsic.json.JsonLimits.construct",
            Self::JsonDecodeOptionsConstruct => "intrinsic.json.JsonDecodeOptions.construct",
            Self::JsonEncodeOptionsConstruct => "intrinsic.json.JsonEncodeOptions.construct",
            ...
            Self::YamlLimitsDefaults => "intrinsic.yaml.YamlLimits.defaults",
            Self::YamlLimitsConstruct => "intrinsic.yaml.YamlLimits.construct",
            Self::YamlLimitsCreate => "intrinsic.yaml.YamlLimits.create",
            ...
            Self::YamlDecode => "std.yaml.decode",
            Self::YamlDecodeAll => "std.yaml.decodeAll",
            Self::YamlEncodeValue => "std.yaml.encode",
            Self::YamlEncode => "std.yaml.encode",
            Self::YamlEncodeCanonical => "std.yaml.encodeCanonical",
            Self::YamlReaderFromBytes => "std.yaml.YamlReader.fromBytes",
            Self::YamlReaderFromReader => "std.yaml.YamlReader.fromReader",
            Self::YamlReaderNext => "std.yaml.YamlReader.next",
            Self::YamlReaderOwn => "std.yaml.YamlReader.own",
            Self::YamlReaderFinish => "std.yaml.YamlReader.finish",
            Self::YamlWriterToWriter => "std.yaml.YamlWriter.toWriter",
            Self::YamlWriterWrite => "std.yaml.YamlWriter.write",
            Self::YamlWriterFinish => "std.yaml.YamlWriter.finish",
            ...
            Self::EncodingBase64AlphabetStandard => "intrinsic.encoding.Base64Alphabet.Standard",
            Self::EncodingBase64AlphabetUrlSafe => "intrinsic.encoding.Base64Alphabet.UrlSafe",
            Self::EncodingBase64PaddingRequired => "intrinsic.encoding.Base64Padding.Required",
            Self::EncodingBase64PaddingOmitted => "intrinsic.encoding.Base64Padding.Omitted",
            Self::EncodingHexCaseLower => "intrinsic.encoding.HexCase.Lower",
            Self::EncodingHexCaseUpper => "intrinsic.encoding.HexCase.Upper",
            Self::EncodingHexCaseAny => "intrinsic.encoding.HexCase.Any",
            Self::EncodingLimitsDefaults => "intrinsic.encoding.EncodingLimits.defaults",
            Self::EncodingLimitsCreate => "intrinsic.encoding.EncodingLimits.create",
            Self::EncodingBase64OptionsCreate => "intrinsic.encoding.Base64Options.create",
            Self::EncodingBase64OptionsStandard => "intrinsic.encoding.Base64Options.standard",
            Self::EncodingBase64OptionsUrlSafe => "intrinsic.encoding.Base64Options.urlSafe",
            Self::EncodingBase64OptionsUrlSafeUnpadded => {
                "intrinsic.encoding.Base64Options.urlSafeUnpadded"
            }
            Self::EncodingBase64OptionsEncode => "std.encoding.Base64Options.encode",
            Self::EncodingBase64OptionsDecode => "std.encoding.Base64Options.decode",
            Self::EncodingBase64OptionsEncodeTo => "std.encoding.Base64Options.encodeTo",
            Self::EncodingBase64OptionsDecodeFrom => "std.encoding.Base64Options.decodeFrom",
            Self::EncodingBase64OptionsEncoder => "std.encoding.Base64Options.encoder",
            Self::EncodingBase64OptionsDecoder => "std.encoding.Base64Options.decoder",
            Self::EncodingHexOptionsCreate => "intrinsic.encoding.HexOptions.create",
            Self::EncodingHexOptionsLower => "intrinsic.encoding.HexOptions.lower",
            Self::EncodingHexOptionsUpper => "intrinsic.encoding.HexOptions.upper",
            Self::EncodingHexOptionsAnyCase => "intrinsic.encoding.HexOptions.anyCase",
            Self::EncodingHexOptionsEncode => "std.encoding.HexOptions.encode",
            Self::EncodingHexOptionsDecode => "std.encoding.HexOptions.decode",
            Self::EncodingHexOptionsEncodeTo => "std.encoding.HexOptions.encodeTo",
            Self::EncodingHexOptionsDecodeFrom => "std.encoding.HexOptions.decodeFrom",
            Self::EncodingHexOptionsEncoder => "std.encoding.HexOptions.encoder",
            Self::EncodingHexOptionsDecoder => "std.encoding.HexOptions.decoder",
            Self::EncodingBase64EncoderPush => "std.encoding.Base64Encoder.push",
            Self::EncodingBase64EncoderFinish => "std.encoding.Base64Encoder.finish",
            Self::EncodingBase64DecoderPush => "std.encoding.Base64Decoder.push",
            Self::EncodingBase64DecoderFinish => "std.encoding.Base64Decoder.finish",
            Self::EncodingHexEncoderPush => "std.encoding.HexEncoder.push",
            Self::EncodingHexEncoderFinish => "std.encoding.HexEncoder.finish",
            Self::EncodingHexDecoderPush => "std.encoding.HexDecoder.push",
            Self::EncodingHexDecoderFinish => "std.encoding.HexDecoder.finish",
    ...
    pub const fn is_async(self) -> bool {
        matches!(
            ...
            Self::ConsoleFlush
                ...
                | Self::SyncMutexLock
                | Self::SyncRwLockRead
                | Self::SyncRwLockWrite
                | Self::SyncConditionWait
                ...
                | Self::YamlReaderFromReader
                | Self::YamlWriterToWriter
                | Self::YamlWriterWrite
                | Self::YamlWriterFinish
                | Self::EncodingBase64OptionsEncodeTo
                | Self::EncodingBase64OptionsDecodeFrom
                | Self::EncodingHexOptionsEncodeTo
                | Self::EncodingHexOptionsDecodeFrom
...
mod error_tests {
    ...
    fn bootstrap_process_types_do_not_expose_bytes_compatibility_aliases() {
        ...
        let cases = [
            ...
            ("yaml", "YamlLimits", IntrinsicType::YamlLimits),
            ("yaml", "YamlOptions", IntrinsicType::YamlOptions),
            ("yaml", "Value", IntrinsicType::YamlValue),
            ("yaml", "ValueView", IntrinsicType::YamlValueView),
            ("yaml", "YamlReader", IntrinsicType::YamlReader),
            ("yaml", "YamlWriter", IntrinsicType::YamlWriter),
            (
                "messagepack",
                "MessagePackLimits",
