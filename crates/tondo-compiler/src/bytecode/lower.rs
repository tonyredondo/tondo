...
fn intrinsic_type(value: IntrinsicType) -> bc::BytecodeIntrinsicType {
    match value {
        ...
        IntrinsicType::Mutex => bc::BytecodeIntrinsicType::Mutex,
        IntrinsicType::MutexGuard => bc::BytecodeIntrinsicType::MutexGuard,
        IntrinsicType::RwLock => bc::BytecodeIntrinsicType::RwLock,
        IntrinsicType::ReadGuard => bc::BytecodeIntrinsicType::ReadGuard,
        IntrinsicType::WriteGuard => bc::BytecodeIntrinsicType::WriteGuard,
        IntrinsicType::Condition => bc::BytecodeIntrinsicType::Condition,
        IntrinsicType::Semaphore => bc::BytecodeIntrinsicType::Semaphore,
        IntrinsicType::Permit => bc::BytecodeIntrinsicType::Permit,
        IntrinsicType::Once => bc::BytecodeIntrinsicType::Once,
        IntrinsicType::Barrier => bc::BytecodeIntrinsicType::Barrier,
        IntrinsicType::Atomic => bc::BytecodeIntrinsicType::Atomic,
        ...
        IntrinsicType::File => bc::BytecodeIntrinsicType::File,
        IntrinsicType::Directory => bc::BytecodeIntrinsicType::Directory,
        IntrinsicType::Metadata => bc::BytecodeIntrinsicType::Metadata,
        IntrinsicType::OpenMode => bc::BytecodeIntrinsicType::OpenMode,
        ...
        IntrinsicType::JsonLimits => bc::BytecodeIntrinsicType::JsonLimits,
        IntrinsicType::JsonDecodeOptions => bc::BytecodeIntrinsicType::JsonDecodeOptions,
        IntrinsicType::JsonEncodeOptions => bc::BytecodeIntrinsicType::JsonEncodeOptions,
        IntrinsicType::JsonDuplicatePolicy => bc::BytecodeIntrinsicType::JsonDuplicatePolicy,
        IntrinsicType::JsonUnknownFieldPolicy => bc::BytecodeIntrinsicType::JsonUnknownFieldPolicy,
        IntrinsicType::JsonNumberPolicy => bc::BytecodeIntrinsicType::JsonNumberPolicy,
